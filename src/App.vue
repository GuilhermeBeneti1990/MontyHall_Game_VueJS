<template>
    <div id="app">
        ...
        <div class="form">
            ...
            <div v-if="!started">
                <label for="selectedDoor">What is the award winning door?</label>
        ...
        <div class="instruction">
            <h2>Instructions</h2>
            <p><span class="steps">1)</span> Choose the quantity of doors would you like</p>
            <p><span class="steps">2)</span> Pick the door winning without your partneer see</p>
            <p><span class="steps">3)</span>) Say it to your partneer to choose one door and try his luck</p>
